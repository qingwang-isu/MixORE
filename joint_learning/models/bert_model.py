...
class BertForMixORE(BertPreTrainedModel):
    """
    ...
    def __init__(self, config):
        ...
        args = main_MixORE.parser.parse_args()
    ...
    def forward(self, input_ids=None, attention_mask=None, labels=None, token_type_ids=None, position_ids=None,
                head_mask=None, inputs_embeds=None, e1_pos=None, e2_pos=None, aug_pos=None, sentence_data=None):
        ...
        classifier_output = self.last_fc(e_pos_output)

        return e_pos_output, classifier_output
        #return e_pos_output


# f_theta1
class RelationClassification(BertForMixORE):
    def __init__(self, config):
        super().__init__(config)


# g_theta2
class LabelGeneration(BertForMixORE):
    def __init__(self, config):
        super().__init__(config)
